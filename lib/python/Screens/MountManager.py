...
class HddMount(Screen):
	skin = """
<screen position="center,225" size="1300,720" title="Mount Manager">
...
<convert type="ServiceName">Name</convert></widget>
                 <ePixmap pixmap="skin_default/mbb.png" position="980,200" size="240,240" alphatest="on" />
...
<ePixmap pixmap="SFTfullhd/menu/exit2.png" position="1192,650" size="48,48" alphatest="blend"/>
<ePixmap pixmap="SFTfullhd/buttons/red48x48.png" position="278,650" size="48,48" alphatest="blend"/>
<ePixmap pixmap="SFTfullhd/buttons/green48x48.png" position="626,650" size="48,48" alphatest="blend"/>
<ePixmap pixmap="SFTfullhd/buttons/yellow48x48.png" position="926,650" size="48,48" alphatest="blend"/>
		<widget name="key_red" position="350,655" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" transparent="1" />		<widget name="key_green" position="175,571" zPosition="1" size="140,1340" font="Regular;20" halign="center" valign="center"  />
<widget name="key_green" position="680,650" zPosition="1" size="140,50" font="Regular;20" halign="center" valign="center" transparent="1" />		
<widget name="key_yellow" position="980,655" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" transparent="1" /> 
		<widget name="key_blue" position="475,551" zPosition="1" size="140,1340" font="Regular;20" halign="center" valign="center" transparent="1" />		<widget source="list" render="Listbox" position="10,50" size="620,450" scrollbarMode="showOnDemand" >
